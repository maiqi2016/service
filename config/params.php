...
return [
    ...
    'sms_id' => '[SECRET:sms_id]',
    'sms_secret' => '[SECRET:sms_secret]',
    ...
    'sms_tpl_apply_refund_success' => '您申请的订单 % 退款已成功通过，退款金额共计 %s，退款金额最晚将在3个工作日内按支付原路退回到您的账户内，请注意账户明细。',
    'sms_tpl_apply_refund_fail' => '您申请的订单 % 退款已被拒绝，退款金额共计 %s，原因是 %s。',
